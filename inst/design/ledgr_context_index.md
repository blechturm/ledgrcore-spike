...
| `inst/design/horizon.md` | Stage 6 verdict cross-link and direct K1 quote source. | Re-read the 2026-05-30 `ledgrcore` sister-package entry, 2026-06-01 measurement-spike gate, repo-split update, decision thresholds, and R-side substrate framing for `inst/design/spikes/k1_measurement_spike/verdict.md`. |
